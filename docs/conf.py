...
html_context = {
    ...
    "github_repo": 'hello_word',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/Zeus/hello_word",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'hello_world'),
                os.path.join(root_path, 'hello_world/migrations')])
